...
export default function HomeContact() {
  return (
    <section className='flex flex-col gap-24'>
        ...
        <Button link='https://calendly.com/chambet-dev/30min' text='Schedule a consultation' icon={"arrow-right.svg"} classBtn={"group bg-teal-400 hover:bg-none hover:bg-black "} classImg={"group-hover:rotate-[-45deg] transition-all duration-400"} />
    </section>
  )
}
