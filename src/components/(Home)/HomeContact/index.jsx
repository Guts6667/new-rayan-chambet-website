...
export default function HomeContact() {
  return (
    <section className='flex flex-col gap-24'>
        ...
        <Button link='/contact' text='Schedule a consultation' icon={"arrow-right.svg"} classBtn={"group bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-green-300 to-purple-400 hover:bg-none hover:bg-black "} classImg={"group-hover:rotate-[-45deg] transition-all duration-400"} />
    </section>
  )
}
